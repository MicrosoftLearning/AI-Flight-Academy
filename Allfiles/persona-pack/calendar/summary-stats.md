...
::: warning Spoilers
This file gives away the answers. It is intended for facilitators or teams that are stuck after exploring the raw inbox and calendar files.
:::

## 30-day meeting roll-up

| Metric | Value |
|---|---:|
| Total calendar hours | 67.25 |
| Accepted / organizer hours | 58.25 |
| Tentative hours | 4.5 |
| Declined hours | 4.5 |
| Tentative or declined share | 13.4% |
| Self-organized hours | 18.0 |
| Self-organized share | 26.8% |

## Hours by inferred category
...
> Category totals overlap when a meeting serves more than one purpose. Use them as behavioral signals, not as an accounting ledger.
...
| Date | Scheduled status | What displaced or weakened it |
|---|---|---|
| Fri Jul 3 | Declined | Sales collateral office hours earlier the same day |
| Fri Jul 10 | Tentative | Paid media readiness and launch page slip |
| Fri Jul 17 | Declined | Executive launch prep conflict hold |
| Fri Jul 24 | Declined | Sales launch readiness fire drill |

## Average response latency by sender

Calculated from received messages and matching sent replies in the inbox corpus.
