...
This is a *doing* problem, not an *awareness* problem. Partners can describe DLP; they fumble the actual configuration. The mistakes are concrete and repeatable.
...
- "Fast" + "hands-on" + "not a webinar" pulls against build-time-heavy formats.
- The audience is explicitly partners and explicitly technical.
