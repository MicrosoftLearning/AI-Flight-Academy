...
Governance is the #1 blocker in customer conversations. Admins want to know how to see, gate, and stop agent actions. The feature set is largely locked, but a few settings may still shift before GA.
...
- "Customers" is doing a lot of work here — is it IT admins? Security? Business decision-makers? Partners who deploy for them?
- Governance is stable enough to teach, but "a few settings may still shift" is a flag for anything that needs locked objectives.
