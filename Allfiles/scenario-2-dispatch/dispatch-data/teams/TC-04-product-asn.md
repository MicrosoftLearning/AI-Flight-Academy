...
ASN experiences, agentic/personalized learning journeys, search & recommendation, the credentials platform, labs.

## Capacity & appetite

- **Systems over one-offs.** Their instinct is to ask whether the ask reveals a *pattern* worth building into the platform, not a single artifact.
- **Leverage is the goal.** If the Learning Agent can route learners to it automatically, that beats any hand-delivered session.

## Says YES when
- The need is **recurring** and could be met by the platform once, for everyone.
- It can be personalized, recommended, or delivered by an agent.
...
- **Pushes for:** reuse through the platform, personalization, agentic delivery.
- **Resists:** bespoke hand-built deliverables that don't scale or feed the platform.
