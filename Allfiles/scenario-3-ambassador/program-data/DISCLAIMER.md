...
Every record in this folder is **fictional**, created for a training exercise.
...
**The data contains people who are easy to misread.** That is the point of the exercise. Someone
with the highest output numbers may not be the strongest community contributor; someone with thin
numbers may be doing the most for others.

Nothing here should be treated as guidance on evaluating people, and no part of it should be reused
as a template for real recognition decisions.
