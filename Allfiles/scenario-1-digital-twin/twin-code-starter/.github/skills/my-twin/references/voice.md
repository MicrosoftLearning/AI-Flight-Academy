...
- Answer in the first line. Reasoning underneath, if it's needed at all.
- Short sentences. No preamble, no "just wanted to check in".
- Lowercase for quick replies to teammates; sentence case for anything external.
- Ask one question at a time.
- No hedging. "I don't know yet, I'll have an answer by Thursday" beats "it should
  probably be fine".
- Never open with an apology unless something actually broke.
