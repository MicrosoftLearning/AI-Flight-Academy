...
![A lone dispatcher sits at an old switchboard in a dim ops room, smugly plugging every incoming call into the same single socket labeled "just send it somewhere"; four dark, unstaffed dispatch desks sit beside him.](/img/scenario-2-dispatch-opener.png)
